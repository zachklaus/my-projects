'''
  Implements a min priority queue using a min heap.  It supports the
...
class PQ():
    ...
    def _hasLeftChild(self, j):
        # replace this:
        index = self._leftChildPos(j)
        last = len(self._HeapArr) - 1
    ...
    def _bubbleUp(self, j):
        # replace this:
        index = j
        parentIndex = self._parentPos(j)
       
        while index > 0 and self._HeapArr[index] < self._HeapArr[parentIndex]:
            self._swap(index, parentIndex)
            index = parentIndex
            parentIndex = self._parentPos(index)
    ...
    def _heapify(self, j):
        # replace this:
        current = self._HeapArr[j]
        right = current
        left = current
        
        if self._hasLeftChild(j):
            left = self._HeapArr[self._leftChildPos(j)]
        
        if self._hasRightChild(j):
            right = self._HeapArr[self._rightChildPos(j)]
        
        smallest = min(current,left,right)
        
        if smallest != current:
            self._swap(current._index, smallest._index)
            self._heapify(current._index)
        else:
            return
    ...
    def extractMin(self):
        ...
        self._swap(0, len(self._HeapArr)-1)
        del self._HeapArr[len(self._HeapArr)-1]
        self._heapify(0)
        return minimum
...
if __name__ == '__main__':
    ...
    P.insert(8,(0, None, None))
    Item = P.insert(10,(1, None, None))
    P.insert(6,(2, None, None))
    P.insert(9,(3, None, None))
    P.insert(7,(4, None, None))
    P.insert(2,(345,None,None))
    P.insert(1,(2355,None,None)) 
    print(P)
    ...
    P.insert(43,(None,None,None))
    P.insert(13,(None,None,None))
    P.insert(5,(None,None,None))
    P.insert(23,(None,None,None))
    P.insert(14,(None,None,None))
    P.insert(22,(None,None,None))
    P.insert(35,(None,None,None))
    P.insert(111,(None,None,None))
    
    print(P)
    
    print("\nextractMin(): ", P.extractMin())
    ...
    """
    Item = P.insert(12,(123,None,None))
    print(P)
    P.reduceKey(Item, 3)
    print(P)
    Item2 = P.insert(6,(234,None,None))
    print(P)
    P.reduceKey(Item2, 5)
    print(P)
    P.insert(12,(222,None,None))
    print(P)
    Item3 = P.insert(11,(111,None,None))
    print(P)
    P.reduceKey(Item3, 6)
    print(P)
    
    min1 = P.findMin()
    print("\nmin from findMin(): ", min1)
    print(P)
    min2 = P.extractMin()
    print("\nmin from extractMin(): ", min2)
    print(P)
    
    
    Items = [None] * 5
    Items[0] = P.insert(8,(0, None, None))
    Items[1] = P.insert(10,(1, None, None))
    Items[2] = P.insert(6,(2, None, None))
    Items[3] = P.insert(9,(3, None, None))
    Items[4] = P.insert(7,(4, None, None))
    ...
    #print ('The second element is the data describing the element (a tuple in this case.')
    #print ('The third element is the index of the position of the reference')
    #print (' to the element in the Heap array.')
    #for i in range(5):
    #    print (Items[i])
    #print ('----')
    ...
    #  This could suggest what you need to do to the ._value field after
    #  performing a reduceKey operation.
    Items[3]._value = (3, 2, 6.5)
    print ('---------')
    #print ('State of the Items array after a reduceKey on Items[3]:')
    #for i in range(5):
        #print (Items[i])
    #print ('----')
    ...
    print(P)
    print('---------')
    print("minimum from findMin(): ", P.findMin())
    print('---------')
    minimum = P.extractMin()
    print("minimum from extractMin(): ",minimum)
    print ('----')
    print ('State of the heap array after extracting min:')
    print(P)
    print('---------')
    print("State of the heap after some insertions")
    P.insert(1,(5,None,None))
    print(P)
    """
