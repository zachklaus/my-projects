...
export default class Footer extends Component {
        ...
        <div className="application-width">
          <div className="footer-copyright">
            ...
            <div className="footer-logo-wrapper">
              <a href="" className="company-sub-widget" target="_blank">
                <FooterLogo/>
              </a>
            </div>
          </div>
  ...
  footerCopyright() {
    ...
    return (
      <div>
        <ul>
          <li><a href="" className="company-sub-widget">Apply to CSU</a></li>
          <li><a href="" className="company-sub-widget">Contact CSU</a></li>
          <li><a href="" className="company-sub-widget">Disclaimer</a></li>
          <li><a href="" className="company-sub-widget">Equal Opportunity</a></li>
          <li><a href="" className="company-sub-widget">Privacy Statement</a></li>
          <br/>
